...
public class MoListViewAdapter extends ArrayAdapter<MorStudents> {

    private Context mContext;
    ProgressDialog progressDialog;
    String finalResult;
    HttpParse httpParse = new HttpParse();
    String HttpURL = "http://www.mucaddam.pk/abdullah/vanapp/mor_att.php";
    ...
    public MoListViewAdapter(Context context, int resource, @NonNull ArrayList<MorStudents> object) {
    ...
    public class MarkAbs extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String login_url = "http://www.mucaddam.pk/abdullah/vanapp/mor_att_abs.php";
    ...
    public class SendPushNotification extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String type = params[0];
            String login_url = "http://www.mucaddam.pk/abdullah/vanapp/noti_ind_mor_att.php";
