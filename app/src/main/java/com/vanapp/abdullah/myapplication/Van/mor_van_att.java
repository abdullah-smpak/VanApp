...
import com.vanapp.abdullah.myapplication.Adpters.MoListViewAdapter;
...
public class mor_van_att extends AppCompatActivity implements LocationListener{

    String van_no ;
    ArrayList<MorStudents> students = null;
    MoListViewAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mor_van_att);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new FancyAlertDialog.Builder(mor_van_att.this)
                        .setTitle("Notify")
                        ...
                        .OnPositiveClicked(new FancyAlertDialogListener() {
                            ...
                            public void OnClick() {
                               ...
                               String date = mdformat.format(calendar.getTime());
                                ...
                                //Present
                                SendPushNotificationPre sendPushNotificationMor = new SendPushNotificationPre(mor_van_att.this);
                                sendPushNotificationMor.execute(type, van_no,date);

                                //Absent
                                SendPushNotificationAbs sendPushNotificationEve = new SendPushNotificationAbs(mor_van_att.this);
                                sendPushNotificationEve.execute(type, van_no,date);


                                /*Intent intent1 = new Intent(mor_van_att.this, Driver_Mainpage.class);
        ...
        String type = "van_no";
        FetchKids fetchKids = new FetchKids(mor_van_att.this);
    ...
    public void onLocationChanged(Location location) {
        Toast.makeText(this, "Chaned", Toast.LENGTH_SHORT).show();
    }
    ...
    public class FetchKids extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(mor_van_att.this, "Please Wait...", null, true, true);
        ...
        protected void onPostExecute(String result) {
            ...
            adapter = new MoListViewAdapter(mor_van_att.this, R.layout.model,students);
    ...
    public class SendPushNotificationPre extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String type = params[0];
            String login_url = "http://www.mucaddam.pk/abdullah/vanapp/offload_pre.php";
            if (type.equals("van_no")) {
                try {
    ...
    public class SendPushNotificationAbs extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String type = params[0];
            String login_url = "http://www.mucaddam.pk/abdullah/vanapp/offload_abs.php";
            if (type.equals("van_no")) {
                try {
                    String route = params[1];
                    String date = params[2];
