...
public class ListViewAdapter extends ArrayAdapter<Students> {
    ...
    public ListViewAdapter(Context context, int resource, @NonNull ArrayList<Students> object) {
    ...
    public View getView(final int position, View convertView, @NonNull ViewGroup parent) {
        ...
        try {
            ...
            //  final Spacecraft thisSpacecraft= .get(position);

            bookNameTextView.setText(getItem(position).getName());


            String url = "http://www.mucaddam.pk/abdullah/lms/" + getItem(position).getImg();
            ...
            chkTechExists.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (chkTechExists.isChecked()) {
                        ...
                        //Toast.makeText(mContext, cls+"", Toast.LENGTH_SHORT).show();
                        ...
                        cls = getItem(position).getCls_id();
                        //Toast.makeText(mContext, "Time:"+time + ","+ "Date:"+date, Toast.LENGTH_SHORT).show();
                        MarkAtt(id, cls, date, status);
    ...
    private void MarkAtt(String std_id_holder, String class_holder, String date_holder, String status_holder) {
        class MarkAttClass extends AsyncTask<String, Void, String> {

            @Override
            protected void onPreExecute() {
                super.onPreExecute();

                progressDialog = ProgressDialog.show(mContext, "Marking..", null, true, true);
        ...
        MarkAttClass markAttClass = new MarkAttClass();

        markAttClass.execute(std_id_holder, class_holder, date_holder, status_holder);
    }
    ...
    public class MarkAbs extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String login_url = "http://www.mucaddam.pk/abdullah/lms/att_abs.php";
