...
public class Assignment extends AppCompatActivity {
    ...
    String HttpURL = "http://www.mucaddam.pk/abdullah/lms/class_ass.php";
    ...
    String marks_holder, cls_holder, sub_holder, fnam_name_holder, clsresult = null, clsline = null, couresult = null, couline = null, teacher_name, filename;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ass_img = findViewById(R.id.ass_img);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                marks_holder = marks.getText().toString();
                ...
                try {
                    clsact(cls_holder, sub_holder, imagetostr(photo1), strDate, teacher_name, filename, marks_holder);

                } catch (Exception ex) {
                    Toast.makeText(Assignment.this, "Please Fill Completely", Toast.LENGTH_SHORT).show();
                }
        ...
        ass_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String imageFileName = null;
                filename = fnam.getText().toString();
                if (filename.equals("")) {
                    Toast.makeText(Assignment.this, "Enter File Name First!", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void spinner_sch1() {
        try {
            ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(Assignment.this, android.R.layout.simple_dropdown_item_1line, classes);
    ...
    private void spinner_sch2() {
        try {
            ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(Assignment.this, android.R.layout.simple_dropdown_item_1line, courses);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == RESULT_OK) {
                ...
                ass_img.setImageURI(Uri.parse(imageFilePath1));
                photo1 = ((BitmapDrawable) ass_img.getDrawable()).getBitmap();
    ...
    private void clsact(String cls_holder, String sub_holder, String img_holder,
                        String date_holder, String teacher_name, String filename, String marks_holder) {
        ...
        class Clsactclass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(Assignment.this, "Uploading...", null, true, true);
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(Assignment.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();


                new FancyAlertDialog.Builder(Assignment.this)
                        .setTitle("Add More")
                        ...
                        .OnNegativeClicked(new FancyAlertDialogListener() {
                            @Override
                            public void OnClick() {
                                Intent intent = new Intent(Assignment.this, TeacherMain.class);
            ...
            protected String doInBackground(String... params) {
                ...
                hashMap.put("ass_class", params[0]);
                hashMap.put("ass_subject", params[1]);
                hashMap.put("ass_image", params[2]);
                hashMap.put("ass_date", params[3]);
                hashMap.put("teacher_name", params[4]);
                hashMap.put("filename", params[5]);
                hashMap.put("marks", params[6]);
        ...
        clsactClass.execute(cls_holder, sub_holder, img_holder,
                date_holder, teacher_name, filename, marks_holder);
