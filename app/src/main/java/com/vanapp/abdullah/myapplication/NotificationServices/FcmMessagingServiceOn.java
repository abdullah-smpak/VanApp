...
public class FcmMessagingServiceOn extends FirebaseMessagingService {
    String type = "";
    ...
    private void sendNotification(String messageBody)
    {
        ...
        notificationBuilder.setSmallIcon(R.drawable.pickicon);
        notificationBuilder.setLargeIcon(BitmapFactory.decodeResource(this.getResources(),R.drawable.pickicon));
