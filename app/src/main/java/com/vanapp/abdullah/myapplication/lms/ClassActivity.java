...
public class ClassActivity extends AppCompatActivity {
    ...
    MaterialBetterSpinner sp_class, sp_subject;
    Button upload;
    EditText fnam;
    ImageView img;
    ...
    String HttpURL = "http://www.mucaddam.pk/abdullah/lms/class_act.php";
    ...
    String cls_holder, sub_holder, fnam_name_holder, clsresult = null, clsline = null, couresult = null, couline = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    clsact(strDate, cls_holder, sub_holder, fnam_name_holder, imagetostr(photo1));
                } catch (Exception ex) {
                    Toast.makeText(ClassActivity.this, "Somthing Went Wrong!!", Toast.LENGTH_SHORT).show();
                }
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String filename = fnam.getText().toString();
                if (filename.equals("")) {
                    Toast.makeText(ClassActivity.this, "Enter File Name First!", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void spinner_sch1() {
        try {
            ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(ClassActivity.this, android.R.layout.simple_dropdown_item_1line, classes);
    ...
    private void spinner_sch2() {
        try {
            ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(ClassActivity.this, android.R.layout.simple_dropdown_item_1line, courses);
    ...
    private void fetchcourse() {
        ...
        try {
            ...
            for (int i = 0; i < JA.length(); i++) {
                json = JA.getJSONObject(i);
                courses[i] = json.getString("course_name");
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == RESULT_OK) {
                ...
                img.setImageURI(Uri.parse(imageFilePath1));
                photo1 = ((BitmapDrawable) img.getDrawable()).getBitmap();
    ...
    private void clsact(String date_holder, String cls_holder, String sub_holder,
                        String fnam_name_holder, String img_holder) {
        ...
        class Clsactclass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(ClassActivity.this, "Uploading...", null, true, true);
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(ClassActivity.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(String... params) {
                ...
                hashMap.put("cls", params[1]);
                hashMap.put("subject", params[2]);
                hashMap.put("filename", params[3]);
                hashMap.put("img", params[4]);
        ...
        try {
            clsactClass.execute(date_holder, cls_holder, sub_holder,
                fnam_name_holder, img_holder);
        } catch (Exception ex) {
            Toast.makeText(this, "Please Fill Completely", Toast.LENGTH_SHORT).show();
        }
