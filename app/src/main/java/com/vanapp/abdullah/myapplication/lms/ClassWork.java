...
public class ClassWork extends AppCompatActivity {
    ...
    String HttpURL = "http://www.mucaddam.pk/abdullah/lms/class_cw.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_cw = findViewById(R.id.img_cw);
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(ClassWork.this, "Please Fill Completely", Toast.LENGTH_SHORT).show();
                }
        ...
        img_cw.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String imageFileName = null;
                 filename = fnam.getText().toString();
                if (filename.equals("")) {
                    Toast.makeText(ClassWork.this, "Enter File Name First!", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void spinner_sch1() {
        try {
            ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(ClassWork.this, android.R.layout.simple_dropdown_item_1line, classes);
    ...
    private void spinner_sch2() {
        try {
            ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(ClassWork.this, android.R.layout.simple_dropdown_item_1line, courses);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == RESULT_OK) {
                ...
                img_cw.setImageURI(Uri.parse(imageFilePath1));
                photo1 = ((BitmapDrawable) img_cw.getDrawable()).getBitmap();
    ...
    private void clsact(String cls_holder, String sub_holder, String img_holder,
        ...
        class Clsactclass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(ClassWork.this, "Uploading...", null, true, true);
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(ClassWork.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();

                new FancyAlertDialog.Builder(ClassWork.this)
                        .setTitle("Add More")
                        ...
                        .OnPositiveClicked(new FancyAlertDialogListener() {
                            ...
                            public void OnClick() {
                                finish();
                                Intent intent = new Intent(ClassWork.this, ClassWork.class);
                        ...
                        .OnNegativeClicked(new FancyAlertDialogListener() {
                            @Override
                            public void OnClick() {
                                Intent intent = new Intent(ClassWork.this, TeacherMain.class);
            ...
            protected String doInBackground(String... params) {
                ...
                hashMap.put("cw_class", params[0]);
                hashMap.put("cw_subject", params[1]);
                hashMap.put("cw_image", params[2]);
                hashMap.put("cw_date", params[3]);
