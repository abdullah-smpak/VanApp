...
public class Test extends AppCompatActivity {
    ...
    String HttpURL = "http://www.mucaddam.pk/abdullah/lms/class_ct.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        test_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (filename.equals("")) {
                    Toast.makeText(Test.this, "Enter File Name First!", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void spinner_sch1() {
        try {
            ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(Test.this, android.R.layout.simple_dropdown_item_1line, classes);
    ...
    private void spinner_sch2() {
        try {
            ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(Test.this, android.R.layout.simple_dropdown_item_1line, courses);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == RESULT_OK) {
                ...
                test_img.setImageURI(Uri.parse(imageFilePath1));
                photo1 = ((BitmapDrawable) test_img.getDrawable()).getBitmap();
    ...
    private void clsact(String cls_holder, String sub_holder, String img_holder,
        ...
        class Clsactclass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(Test.this, "Uploading...", null, true, true);
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(Test.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();


                new FancyAlertDialog.Builder(Test.this)
                        .setTitle("Add More")
                        ...
                        .OnNegativeClicked(new FancyAlertDialogListener() {
                            @Override
                            public void OnClick() {
                                Intent intent = new Intent(Test.this, TeacherMain.class);
            ...
            protected String doInBackground(String... params) {
                ...
                hashMap.put("ct_class", params[0]);
                hashMap.put("ct_subject", params[1]);
                hashMap.put("ct_image", params[2]);
                hashMap.put("ct_date", params[3]);
