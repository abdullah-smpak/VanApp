...
public class Syllabus extends AppCompatActivity {
    ...
    String HttpURL = "http://www.mucaddam.pk/abdullah/lms/class_sy.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        syl_img = findViewById(R.id.syl_img);
        ...
        syl_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String imageFileName = null;
                filename = fnam.getText().toString();
                if (filename.equals("")) {
                    Toast.makeText(Syllabus.this, "Enter File Name First!", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void spinner_sch1() {
        try {
            ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(Syllabus.this, android.R.layout.simple_dropdown_item_1line, classes);
    ...
    private void spinner_sch2() {
        try {
            ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<>(Syllabus.this, android.R.layout.simple_dropdown_item_1line, courses);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == RESULT_OK) {
                ...
                syl_img.setImageURI(Uri.parse(imageFilePath1));
                photo1 = ((BitmapDrawable) syl_img.getDrawable()).getBitmap();
    ...
    private void clsact(String cls_holder, String sub_holder, String img_holder,
        ...
        class Clsactclass extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(Syllabus.this, "Uploading...", null, true, true);
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(Syllabus.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();

                Intent intent = new Intent(Syllabus.this, TeacherMain.class);
            ...
            protected String doInBackground(String... params) {
                ...
                hashMap.put("sy_class", params[0]);
                hashMap.put("sy_subject", params[1]);
                hashMap.put("sy_image", params[2]);
                hashMap.put("sy_date", params[3]);
